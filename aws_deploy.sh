...
echo "********************************************************"
echo "push images"
docker push 103126352378.dkr.ecr.us-west-1.amazonaws.com/offerdate:phoenix
docker push 103126352378.dkr.ecr.us-west-1.amazonaws.com/web-client:web-client
echo "********************************************************"
echo "Done"
echo "********************************************************"
